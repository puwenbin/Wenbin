...
class DataSaveThread(threading.Thread):
    ...
    def __init__(self,host,user,passwd,db_name,charset,params,table_name):
        ...
        出始化
        '''
        super(DataSaveThread, self).__init__()
        self.host = host
        self.user = user
        self.passwd = passwd
...
def main():
    ...
    params_list = [[['23','http','5678','890','32','21','56'],['23','45','http','890','5678','45','56']],[['23','ping','56','56','78','34','67'],['54','ping','34','54','12','12','78']]]
